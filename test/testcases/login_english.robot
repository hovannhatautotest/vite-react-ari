...
# ----------------------------------LOGIN SUCCESSFULLY-------------------------------------------------------------
LG-04 Verify that Log In successfully accout Admin with valid Email and Mật khẩu
...
LG-05 Verify that Log In successfully account Manager with valid Email and Mật khẩu
    [Tags]    @smoketest    @regression
...
LG-06 Verify that Log In successfully account Staff with valid Email and Mật khẩu
    [Tags]    @smoketest    @regression
...
# ---------------------ERROR MESSAGE------------------------------------------------------------
LG-08 Verify that Log In unsuccessfully because enter incorrect Email
...
LG-09 Verify that Log In unsuccessfully because enter incorrect password
    [Tags]    @smoketest    @regression
     Change language with "Tiếng Anh"
...
LG-10 Verify that Log In unsuccessfully because enter incorrect username and password
    [Tags]    @smoketest    @regression
    Change language with "Tiếng Anh"
    When Enter "email" in "Username" with "_RANDOM_"
...
LG-11 Verify that Log In unsuccessfully because enter password less than 6 characters
    [Tags]    @smoketest    @regression
    Change language with "Tiếng Anh"
    When Enter "email" in "Username" with "_RANDOM_"
...
LG-12 Validation text with "Username" field
    [Tags]    @smoketest    @regression
    Change language with "Tiếng Anh"
...
LG-13 Validation text with "Password" field
    [Tags]    @smoketest    @regression
    Change language with "Tiếng Anh"
    When Enter "email" in "Username" with "_RANDOM_"
    And Click "Log In" button
...
LG-14 Validation text with "Username" field and "Password" field
    [Tags]    @smoketest    @regression
    Change language with "Tiếng Anh"
...
LG-15 Validation text with "Username" field when enter invalid email format
    [Tags]    @smoketest    @regression
    Change language with "Tiếng Anh"

...
#CRU_16: Kiểm tra tạo mới người dùng thành công
#    [Tags]    @smoketest         @regression
#    When Go to page create user
#    And Enter "fullname" in "Họ và tên" with "_RANDOM_"
#    And Enter "email" in "Email" with "_RANDOM_"
...
CRU_24.1: Kiểm tra việc tìm kiếm thành công khi nhập "Vai trò" hợp lệ vào thanh tìm kiếm
    When Login to Admin
    And Click "Quản lý người dùng" menu
    And Search "text" in "Tìm kiếm" with "Quản trị viên"
    Then Show list of "users"

CRU_24.2: Kiểm tra việc tìm kiếm thành công khi nhập "Vai trò" hợp lệ vào thanh tìm kiếm
    When Login to Admin
    And Click "Quản lý người dùng" menu
    And Search "text" in "Tìm kiếm" with "Đại diện cửa hàng"
    Then Show list of "users"

CRU_24.3: Kiểm tra việc tìm kiếm thành công khi nhập "Vai trò" hợp lệ vào thanh tìm kiếm
    When Login to Admin
    And Click "Quản lý người dùng" menu

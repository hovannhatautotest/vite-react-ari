...
CRU-18 Verify that validation text in "Số điện thoại" field greater than 12 characters
    [Tags]          @smoketest         @regression
    Go to page create data
    When Enter "number" in "Số điện thoại" with "0123456789101"
    And Enter "text" in "Họ và tên" with "_RANDOM_"
...
CRU-21 Verify that validation text in "Ngày sinh" field
    [Tags]          @smoketest         @regression
    Go to page create data
...
CRU-25 Verify that Create user successfully when select "Vai trò" with "Staff" & "Lưu lại" button
    Go to page create data
    When Enter invalid information
    And Click select "Vai trò" with "Staff"
    And Click "Lưu lại" button
...
CRU-30 Verify that Create user successfully when select "Vai trò" with "Manager" & "Lưu và tạo mới" button
    Go to page create data
    When Enter invalid information
    And Click select "Vai trò" with "Supper Admin"
    And Click "Lưu và tạo mới" button
...
CRU-32 Verify that can see "Mật khẩu" và "Nhập lại mật khẩu" field are displayed as characters
    Go to page create data
    When Enter "text" in "Mật khẩu" with "Nhat@01101999"
    And Enter "text" in "Nhập lại mật khẩu" with "Nhat@01101999"
...
#-------------------------------------VIEW LIST OF USER--------------------------------------------------------------------------------------
CRU-33 Verify that the list of users all Role can be viewed successfully
    Login to admin
    And Click "Người Dùng" menu
    And Click "Danh sách" submenu in "Người Dùng" menu
...
CRU-34 Verify that user can view the list of Staff successfully
    Go to "Danh sách Người dùng" page
    Increase the number of users displayed in the list
    And Click list Role with "Staff"
    Then View User List with "Staff"

CRU-35 Verify that user can view the list of Manager successfully
    Go to "Danh sách Người dùng" page
    Increase the number of users displayed in the list
    And Click list Role with "Manager"
    Then View User List with "Manager"

CRU-36 Verify that user can view the list of Supper Admin successfully
    Go to "Danh sách Người dùng" page
    Increase the number of users displayed in the list
    And Click list Role with "Supper Admin"
    Then View User List with "Supper Admin"

CRU-37 Verify that Admin can search successfully when entering correct keyword to search box with "Họ và tên"
    Go to "Danh sách Người dùng" page
    Search "text" in "Tìm kiếm" with "${username_valid}"
    View User List search key in "Họ và tên" field with "${username_valid}"

CRU-38 Verify that Admin can search successfully when entering correct keyword to search box with "Email"
    Go to "Danh sách Người dùng" page
    Search "email" in "Tìm kiếm" with "${email_valid}"
    View User List search key in "Email" field with "${email_valid}"

CRU-39 Verify that Admin can search successfully when entering correct keyword to search box with "Phone"
    Go to "Danh sách Người dùng" page
    Search "phone" in "Tìm kiếm" with "${phone_number_valid}"
    View User List search key in "Phone" field with "${phone_number_valid}"

CRU-40 Verify that Admin can search successfully when entering correct keyword to search box with "Họ và tên"
    Go to "Danh sách Người dùng" page
    Search "text" in "Tìm kiếm" with "_RANDOM_"
    No users are shown

CRU-41 Verify that Admin can search successfully when entering correct keyword to search box with "Email"
    Go to "Danh sách Người dùng" page
    Search "email" in "Tìm kiếm" with "_RANDOM_"
    No users are shown

CRU-42 Verify that Admin can search successfully when entering correct keyword to search box with "Phone number"
    Go to "Danh sách Người dùng" page
